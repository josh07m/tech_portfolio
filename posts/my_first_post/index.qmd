...
daily_deep_temps <- deep_temps |>
  ...
  summarise(
    ...
    min_temp_deep = min(deep_temps$mean_temp),
    max_temp_deep = max(deep_temps$mean_temp)
  )
deep_temps <- NULL
...
ggplot(
  ...
  labs(
    ...
    caption = "data from ..."
   ) + scale_colour_continuous(low = "#FFBEB2", high = "#AE123A") +
  theme_classic()
...
ggplot(data = daily_shallow_temps,
       mapping = aes(
         x = day_of_year,
         y = min_temp,
         group = year,
    ...
    labs(
       ...
       title = "Average Minimum Temperature Per Day For Every Year",
      caption = "data from ..."
    )  + scale_colour_continuous(low = "#FFBEB2", high = "#AE123A") +
  theme_classic()
...
ggplot(data = daily_shallow_temps,
  ...
  labs(
    ...
    title = "Average Maximum Temperature Per Day For Every Year",
    caption = "data from ..."
  )  + scale_colour_continuous(low = "#FFBEB2", high = "#AE123A") +
  theme_classic()
